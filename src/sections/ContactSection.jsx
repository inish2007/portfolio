    ...
    <section id="contact" ref={ref} className="section-shell">
      ...
      <div className="section-inner flex w-full flex-col items-center">
            ...
            <div className="rounded-xl glass-card p-5 hud-border sm:p-7">
              ...
              <AnimatePresence mode="wait">
                {!sent ? (
                  ...
                  >
                    <div>
                      <label className="mb-3 block font-hud text-[10px] font-medium tracking-widest text-cyan-400/80">
                        SENDER CALLSIGN
                      </label>
                      <input
                        className="input-hud"
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={(event) => setFormState((value) => ({ ...value, message: event.target.value }))}
                        required
                      />
                    </div>
                  ...
                  >
                    ...
                    <button onClick={() => setSent(false)} className="btn-primary mt-6 text-[9px]">
                      NEW TRANSMISSION
                    </button>
                  </motion.div>
                )}
        ...
        >
          ...
          <p className="mt-2 font-ui text-xs text-white/20">Built with React, Three.js,Framer Motionand creativity</p>
        </motion.div>
      </div>
    </section>
  );
